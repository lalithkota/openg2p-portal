...
//                     <Image
//                       className="w-1/2 h-1/2 square-full m-3 max-w-[80%] max-h-[80%]"
  ...
  return (
    <>
      <div className="w-full flex flex-row mx-auto max-w-screen-xl font-fontcustom gap-8 m-4 p-6 md:space-x-6 ">
        <CardItem
          title={page.card.title_a}
          heading={page.card.heading_a1}
          description={page.card.description_a1}
          imagePath="/img/medical.png"
          link={`/${lang}/programs`}
        />
        <CardItem
          title={page.card.title_b}
          heading={page.card.heading_b1}
          description={page.card.description_b1}
          imagePath="/img/person_filled_FILL0_wght400_GRAD0_opsz48.png"
          link="#"
        />
        <CardItem
          title={page.card.title_c}
          heading={page.card.heading_c1}
          description={page.card.description_c1}
          imagePath="/img/applications.png"
...
function CardItem({ title, heading, description, imagePath, link }: {
  title: string;
  heading: string;
  description: string;
  imagePath: string;
  link: string;
    ...
    <div className="flex flex-col w-full bg-brand border border-gray-200 square-lg shadow dark:bg-brand rounded-lg">
      ...
      <div className="mx-auto mb-2">
        <Link href={link} className="text-sm font-medium text-blue-600 dark:text-blue-500 no-underline hover:underline">
          {title}
        </Link>
      </div>
    </div>
