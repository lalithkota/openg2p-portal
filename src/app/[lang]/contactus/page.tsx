    ...
    <div className=" rounded-lg border-gray-200 p-4 mx-4 lg:px-4 m-0 mt-2">
      ...
      <div className='mx-auto max-w-screen-xl'>
        ...
        <div className='container'>
          <h1 className='text-3xl font-bold' style={{ textAlign: 'center', fontFamily: 'Inter, sans-serif', fontSize: '17px', lineHeight: '20px', letterSpacing: '0px', color: '#333333', opacity: 1 }}>Contact OpenG2P </h1>
          <h2>
          OpenG2P Documentations Link : https://docs.openg2p.org/
          </h2>
        </div>
      </div>
    </div>
