...
export default async function Card ({
    ...
    return (
        <>
            <div className="flex flex-col font-fontcustom mt-24 md:flex-row gap-8  m-6 p-4 md:space-x-8 sm:py-4">
                <div className=" flex flex-col w-full bg-brand border border-gray-200 square-lg shadow  dark:bg-brand rounded-lg">
                    ...
                    <div className="mx-auto mb-2">
                        <a href={`/${lang}/programs`} className="text-sm font-medium text-blue-600 dark:text-blue-500 hover:underline ">
                            {page.card.view_all}
                        </a>
                    </div>
                </div>
                <div className=" flex flex-col w-full bg-brand border border-gray-200 square-lg shadow  dark:bg-brand rounded-lg">
                    ...
                    <div className="mx-auto ">
                        <a href={`/${lang}/forms`}className="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">
                            {page.card.view_all}
                        </a>
                    </div>
                </div>
